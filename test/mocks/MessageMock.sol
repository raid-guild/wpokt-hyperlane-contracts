...
contract MessageMock {
     ...
     */
    function id(bytes memory _message) public pure returns (bytes32) {
     ...
     */
    function version(bytes calldata _message) public pure returns (uint8) {
     ...
     */
    function nonce(bytes calldata _message) public pure returns (uint32) {
     ...
     */
    function origin(bytes calldata _message) public pure returns (uint32) {
     ...
     */
    function sender(bytes calldata _message) public pure returns (bytes32) {
